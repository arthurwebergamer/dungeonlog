...
44. [x] **Sistema de flutuante genérico — estendido de "número na Arena" (item 40) pra qualquer ação com feedback: poção, equipar, comprar, vender, melhorar atributo (pedido do usuário, 27/08).** *(pronto, com 2 bugs reais achados e corrigidos durante o teste do próprio usuário)*
